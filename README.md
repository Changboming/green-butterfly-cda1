...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/green-butterfly-cda1)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-butterfly-cda1
```

A live public deployment of this template is available at [https://green-butterfly-cda1.templates.workers.dev](https://green-butterfly-cda1.templates.workers.dev)
